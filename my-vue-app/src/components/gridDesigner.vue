            ...
            <div class="preview-container">
              <div  class="preview-rows" style="width: 50.4px;">
                <div  v-for="(group,index) in grid.groups" :key="index" class="preview-row">
                  <div v-for="(col,index) in group.cols" :key="index" class="preview-col">
                    <div class="preview-col-offset" v-bind:style = "{width : preview_xsoffset(col.data) + 'px'}"></div>
                    <div class="preview-col-width" v-bind:style = "{width : preview_xs(col.data) + 'px'}"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-bind:class="['preview' , 'sm' , 'easing' ,preview==='sm' ? 'active' : '']" v-on:click= "selectPreview('sm')">
            ...
            <div class="preview-container">
              <div  class="preview-rows" style="width: 79.2px;">
                <div  v-for="(group,index) in grid.groups" :key="index" class="preview-row">
                  <div v-for="(col,index) in group.cols" :key="index" class="preview-col">
                    <div class="preview-col-offset" v-bind:style = "{width : preview_smoffset(col.data) + 'px'}"></div>
                    <div class="preview-col-width" v-bind:style = "{width : preview_sm(col.data) + 'px'}"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-bind:class="['preview' , 'md' , 'easing' ,preview==='md' ? 'active' : '']" v-on:click= "selectPreview('md')">
            ...
            <div class="preview-container">
              <div  class="preview-rows" style="width: 115.2px;">
                <div  v-for="(group,index) in grid.groups" :key="index" class="preview-row">
                  <div v-for="(col,index) in group.cols" :key="index" class="preview-col">
                    <div class="preview-col-offset" v-bind:style = "{width : preview_mdoffset(col.data) + 'px'}"></div>
                    <div class="preview-col-width" v-bind:style = "{width : preview_md(col.data) + 'px'}"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-bind:class="['preview' , 'lg' , 'easing' ,preview==='lg' ? 'active' : '']" v-on:click= "selectPreview('lg')">
            ...
            <div class="preview-container">
              <div  class="preview-rows" style="width: 144px;">
                <div  v-for="(group,index) in grid.groups" :key="index" class="preview-row">
                  <div v-for="(col,index) in group.cols" :key="index" class="preview-col">
                    <div class="preview-col-offset" v-bind:style = "{width : preview_lgoffset(col.data) + 'px'}"></div>
                    <div class="preview-col-width" v-bind:style = "{width : preview_lg(col.data)+ 'px'}"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-bind:class = "['sl-container', preview ]">
            ...
            <div class="rows">
              <div v-for="(group,index) in grid.groups" :key="index" class="sl-row easing" id = "row-">
                <draggable class="cols" element="div" v-model="group.cols" :options="dragOptions" :move="onMove" @end="onEndDrag">

                    <resize-observer v-for="col in group.cols" :key="col.order" :preview="preview" :grid="[74,74]" :w="col.data.width" :x="col.data.offset" v-model="col.data" :col="col" class="col dragging" id="col-3">
  ...
  methods: {
    onEndDrag (evnt) {
      ...
      for (let i = 0; i < this.grid.groups.length; i++) {
        previewcol.groups.push({cols: this.grid.groups[i].cols.map(function (obj, index, array) {
          return {data: {
            ...
            md: obj.data.md,
            lg: obj.data.lg,
            xs_offset: obj.data.xs_offset,
            sm_offset: obj.data.sm_offset,
            md_offset: obj.data.md_offset,
            lg_offset: obj.data.lg_offset,
            order: index + 1}
          }
        }, this)})
      }
    ...
    selectPreview (option) {
      ...
      for (i = 0; i < this.grid.groups.length; i++) {
        previewcol.groups.push({cols: this.grid.groups[i].cols.map(function (objIN, index, array) {
          let width = 880
          let offset = 0
          let obj = objIN.data
          switch (this.preview) {
            case 'xs':
              ...
              break
            case 'sm':
              console.log('case sm', obj.sm)
              if (obj.sm !== null && obj.sm !== undefined) {
                console.log('case sm in')
                width = 74 * obj.sm
      ...
      console.log('previewcol', previewcol)
      this.grid = previewcol
    }
  }
}
...
.form-control {
  ...
  border: 1px solid #cccccc;
  border-radius: 4px;
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.072);
...
.form-control:focus {
  border-color: #66afe9;
  outline: 0;
  -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.072), 0 0 8px rgba(102, 172, 233, 0.6);
  box-shadow: inset 0 1px 1px rgba(0,0,0,.072), 0 0 8px rgba(102, 172, 233, 0.6);
}
...
.has-warning .form-control:focus {
  border-color: #a47e3c;
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.072), 0 0 6px #dbc59e;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.072), 0 0 6px #dbc59e;
}
...
.has-error .form-control:focus {
  border-color: #953b39;
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.072), 0 0 6px #d59392;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.072), 0 0 6px #d59392;
}
...
.has-success .form-control:focus {
  border-color: #356635;
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.072), 0 0 6px #7aba7b;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.072), 0 0 6px #7aba7b;
}
...
.dropdown-menu {
  ...
  border-radius: 4px;
  -webkit-box-shadow: 0 6px 12px rgba(0, 0, 0, 0.172);
  box-shadow: 0 6px 12px rgba(0, 0, 0, 0.172);
...
.sl-container.xs .sl-row {
  background: rgba(224, 82, 82, 0.09999999999999998);
}
.sl-container.xs .sl-row.active {
  background: rgba(224, 82, 82, 0.30000000000000004);
}
.sl-container.xs .col .width {
  background-color: #e05252;
}
.sl-container.xs .col .width .col-name {
  left: 7px;
}
.sl-container.xs .col .width .classes {
  left: 7px;
}
...
.sl-container .col:first-child {
  margin-left: 0;
}
.sl-container .col:last-child {
  margin-right: 0;
}
.sl-container .col .remove {
  display: block;
  position: absolute;
  top: 0px;
  right: 5px;
...
.sl-container .col .remove:hover {
  color: #ffffff;
}
.sl-container .col .width {
  width: 60px;
  min-width: 60px;
  height: 100%;
  display: inline-block;
...
.sl-container .col .width:active {
  cursor: col-resize;
}
.sl-container .col .width .offset-handle {
  position: absolute;
  left: 4px;
  top: 5px;
  bottom: 5px;
...
.sl-container .col .width .col-name {
  position: absolute;
  left: 15px;
  top: 0;
  font-size: 10pt;
...
.sl-container .col .width .classes {
  position: absolute;
  bottom: 3px;
  left: 19px;
  font-size: 10pt;
...
.html .output_container pre {
  white-space: pre;
}
.html .output_container pre.prettyprint {
  margin-bottom: 0px;
}
.html .output_container pre.output {
...
.html .output_container pre.markup {
  height: 50%;
}
.html .output_container pre.mixins {
...
.html .options .container-check label {
  margin-bottom: 0px;
}
.html .copy-code {
  background-image: -webkit-gradient(linear, left 0%, left 100%, from(#424242), to(#303030));
  ...
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff424242', endColorstr='#ff303030', GradientType=0);
...
.html.collapsed .options li {
  display: block;
}
.html.collapsed .output {
  display: none;
}
.html.collapsed .planchette {
  display: none;
}
.html.collapsed .planchette.easing {
  display: block;
}
.html.collapsed .copy-code {
  left: 7px;
  right: auto;
}
.copy-output {
...
.hover-guide li.container-guide {
  background-color: #f3f1ec;
}
.hover-guide li.row-guide {
  background-color: #ffd6dc;
}
.hover-guide li.col-guide {
...
.container.output-preview:hover {
  background-color: #f2f2f2;
  outline: 1px solid #666666;
}
.container.output-preview .row {
  outline: 1px solid #e6e6e6;
}
.container.output-preview .row:hover {
  background-color: #fff0f2;
  outline: 1px solid #ff0000;
}
.container.output-preview [class^="col-"] {
  outline: 1px solid #e6e6e6;
  min-height: 150px;
}
.container.output-preview [class^="col-"] .wrap {
  min-height: 150px;
}
.container.output-preview [class^="col-"]:hover {
  background-color: #f0f4ff;
  outline: 1px solid #004cff;
}
.container.output-preview [class^="col-"]:hover .wrap {
  outline: 1px solid #004cff;
}
.preview-pane {
  background: white;
...
.mixin-examples .headlines,
.mixin-examples .stories,
.mixin-examples .comics {
...
.mixin-examples .headlines:before,
.mixin-examples .headlines:after {
  content: " ";
  /* 1 */
...
.mixin-examples .headlines .local {
  position: relative;
  min-height: 1px;
  padding-left: 15px;
  padding-right: 15px;
...
.mixin-examples .headlines .global {
  position: relative;
  min-height: 1px;
  padding-left: 15px;
  padding-right: 15px;
...
.mixin-examples .headlines .online {
  position: relative;
  min-height: 1px;
  padding-left: 15px;
  padding-right: 15px;
...
.mixin-examples .stories:before,
.mixin-examples .stories:after {
  content: " ";
  /* 1 */
...
.mixin-examples .stories .human-interest {
  position: relative;
  min-height: 1px;
  padding-left: 15px;
  padding-right: 15px;
...
.mixin-examples .stories .politics {
  position: relative;
  min-height: 1px;
  padding-left: 15px;
  padding-right: 15px;
...
.mixin-examples .comics:before,
.mixin-examples .comics:after {
  content: " ";
  /* 1 */
...
.mixin-examples .comics .garfield {
  float: left;
  width: 100%;
  position: relative;
  min-height: 1px;
...
.mixin-examples .comics .marmaduke {
  float: left;
  width: 50%;
  position: relative;
  min-height: 1px;
...
.mixin-examples .comics .wizard-of-id {
  float: left;
  width: 50%;
  position: relative;
  min-height: 1px;
